...
public static partial class Module
{
    ...
    public static void Init(ReducerContext ctx)
    {
        ...
        ctx.Db.ScheduledRealGameActivityCheck.Insert(new ScheduledRealGameActivityCheck
        {
            ScheduledId = 0,
            ScheduledAt = new ScheduleAt.Interval(new TimeDuration { Microseconds = REAL_GAME_ACTIVITY_CHECK_INTERVAL_MICROS })
        });
    }
