...
- The project uses the latest stable SpacetimeDB version
- The CLI, SDK, and Runtime versions should be kept in sync
- Check the latest version at: https://github.com/clockworklabs/SpacetimeDB/releases/latest
- To install the latest CLI:
  ...
  ```
- Verify version with: `spacetime --version`
