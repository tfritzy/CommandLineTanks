...
export default __t.row({
  ...
  remainingSmokescreenCooldownMicros: __t.i64().name("RemainingSmokescreenCooldownMicros"),
  hasShield: __t.bool().name("HasShield"),
  remainingOverdriveCooldownMicros: __t.i64().name("RemainingOverdriveCooldownMicros"),
  remainingOverdriveDurationMicros: __t.i64().name("RemainingOverdriveDurationMicros"),
  remainingImmunityMicros: __t.i64().name("RemainingImmunityMicros"),
  remainingRepairCooldownMicros: __t.i64().name("RemainingRepairCooldownMicros"),
  isRepairing: __t.bool().name("IsRepairing"),
  repairStartedAt: __t.u64().name("RepairStartedAt"),
});
