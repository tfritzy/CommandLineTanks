...
import ScheduledHomeworldActivityCheckRow from "./scheduled_homeworld_activity_check_table";
export { ScheduledHomeworldActivityCheckRow };
...
export { ScheduledHomeworldActivityCheck };
...
const tablesSchema = __schema(
  ...
  __table({
    name: 'ScheduledHomeworldActivityCheck',
    indexes: [
      { name: 'ScheduledId', algorithm: 'btree', columns: [
        'scheduledId',
      ] },
    ...
    constraints: [
      { name: 'ScheduledHomeworldActivityCheck_ScheduledId_key', constraint: 'unique', columns: ['scheduledId'] },
    ],
  }, ScheduledHomeworldActivityCheckRow),
  __table({
