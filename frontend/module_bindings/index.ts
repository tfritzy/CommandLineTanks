...
import CheckGameActivity from "./check_game_activity_reducer";
export { CheckGameActivity };
...
export { ScheduledGameActivityCheckRow };
...
export { ScheduledGameActivityCheck };
...
const tablesSchema = __schema(
  ...
  __table({
    name: 'ScheduledGameActivityCheck',
    indexes: [
      { name: 'ScheduledId', algorithm: 'btree', columns: [
        'scheduledId',
      ] },
    ...
    constraints: [
      { name: 'ScheduledGameActivityCheck_ScheduledId_key', constraint: 'unique', columns: ['scheduledId'] },
    ],
  }, ScheduledGameActivityCheckRow),
  __table({
...
const reducersSchema = __reducers(
  ...
  __reducerSchema("CheckGameActivity", CheckGameActivity),
