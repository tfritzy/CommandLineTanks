...
export const COLORS = {
  ...
  TERRAIN: {
    ...
    BLACK_CHECKER: PALETTE.BLUE_MEDIUM,
    WHITE_CHECKER: PALETTE.BLUE_DARK,

    WATER_DEEP: PALETTE.BLUE_DARK,
    ...
    FLOWER_PETAL: PALETTE.RED_MUTED,
    FLOWER_CENTER: PALETTE.ORANGE_MEDIUM,
  },
